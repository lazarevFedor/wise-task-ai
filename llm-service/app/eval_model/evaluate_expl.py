...
from explanations_dataset import expl_dataset
...
def evaluate_model_responses(data,
    ...
    generation parameters, then computes ROUGE and BERTScore against reference answers.
    ...
    Returns:
        dict: Evaluation results containing:
            ...
            - average ROUGE-1, ROUGE-2, and BERTScore F1 scores
            - weighted composite score (25% ROUGE-1 + 25% ROUGE-2 + 50% BERTScore F1)
...
def grid_search(data):
    ...
    composite score (25% ROUGE-1 + 25% ROUGE-2 + 50% BERTScore F1).
    ...
    Returns:
        list: Sorted list of evaluation results for all parameter combinations,
              ...
              - evaluation metrics (ROUGE-1, ROUGE-2, BERTScore F1, weighted_score)
              - generated answers
    """
    ...
    debug(f'Best BERTScore: {best_bertscore['bleu']:.4f}\n'
          f'temp={best_bertscore['temperature']}, '
          f'top_p={best_bertscore['top_p']}, '
          f'top_k={best_bertscore['top_k']}, '
          f'repeat_penalty={best_bertscore['repeat_penalty']}')
